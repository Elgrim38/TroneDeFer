	...
	<body>		
		...
		<div id="getNewPassword">
			<form id="UserGetNewPassword" method="post" action="#">
				<p id="UserGetNewPasswordParaph">Saissisez l'adresse e-mail associer à votre compte</p>
				<a href="#" name="getNewPassword" class="btn-success closeForm">X</a>
				<input type="email" name="email" placeholder="Saississez votre adresse mail">
		...
		<div id="UserLoginForm"class="home-content">
			<form method="post" action="" method="post">
				...
				<input type="submit" class="btn btn-success" name="validation" value="Connexion">			
				<div class="clear"></div>
				<div style='width:100%;'>
